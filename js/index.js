...
$.ajax({
	...
	success: function(data){
		if(data.code == 200){
			...
			window.location.href="userInfor.html?reportId=" + myReportId+"&userId=" + data.data.customerId + "&openId=" + myopenId + "&edition="+edition;
		}else if(data.code == 405){
			window.location.href="userInfor.html?reportId=" + myReportId + "&openId=" + myopenId + "&edition="+edition;
		}else if(data.code == 403){
			window.location.href="supAge.html?reportId=" + myReportId+"&userId=" + data.data.customerId + "&openId=" + myopenId + "&edition="+edition;
