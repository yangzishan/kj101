      ...
      var v = new Vue({
        ...
        data : function(){
          return {
            ...
            valueMax : 100,
            valueMin : 0,
            zhinan : '1、本报告可协助您了解自身的各类情绪状态，建议您认真阅读。如果在阅读的过程中有任何疑问，可向专业人士咨询。<br>2、本报告可作为您评估自身情绪状态的一个参考，而不是诊断。如果需要，强烈建议您向专业人士寻求进一步的咨询和帮助。<br>3、本报告内容分为三大部分：<br>第一部分为情绪画像，您可快速了解自己的情绪关键特征。<br>第二部分为情绪指数，通过雷达图和曲线图，您可直观了解自己的情绪状态。<br>第三部分为情绪解读，您可了解自己各情绪指标的详细解读、分析、建议、历史测试变化趋势等信息。', //指南
            moodViews:[],
            moodViewsList:[],
            metricViews:[],
              ...
              success:function(res){
                if(res.code == 200){
                  ...
                  for(var i=0; i< vm.metricViews.length;i++){
                    ...
                    if(vm.metricViews[i].historyTrendViews && vm.metricViews[i].historyTrendViews != null){
