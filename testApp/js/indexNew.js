...
var myclientType = '';
// var myReportId = 'KJ104IS0007494C180713155357134';
// var myopenId = 'od9apwSiXIR0rSQzN2V5qJV2MPiQ';
...
setupWebViewJavascriptBridge(function(bridge) {
	...
	// 注册JS方法供OC调用
	bridge.registerHandler('goToStore', function(data, responseCallback) {
		//alert('哈哈哈哈');
	...
	$(document).on("click","#goShare",function(){
		//alert('hahahha');
		bridge.callHandler('goToShare', {'price':'100'}, function responseCallback(responseData) {
...
/*$.ajax({
	...
	error : function(obj,msg){console.log(obj+msg + ":查用户出错");}
			...
			window.location.href="supAge.html?reportId=" + myReportId+"&userId=" + data.data.userId + "&userId=" + myuserId + "&edition="+edition;
