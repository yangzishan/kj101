...
var reportId = (getQueryString("reportId") || "KJ501LS0001372K22030313194596");
		...
		getReportPrint:function(){
			...
			$.ajax({
				...
				success:function(res){
					...
					vm.mobile = res.data.userTel;
					vm.sex = res.data.report501.sex
					...
					//vm.payNum = res.data.payNum,
				 	vm.inspectDateStr = res.data.report501.inspectDateStr,
				 	vm.firsts = res.data.report501.reportView.firsts
					...
					vm.filterData()
				 	...
				 	vm.bloodOxygen = res.data.report501.bloodOxygenValue
				 	vm.ecg = res.data.report501.ecg
					go++
					goPrint(go)
				},
