		...
		if(data.code == 200 || data.code == 403){
			...
			success : function(indexData) {
				...
				if(indexData.code == 201){
					...
					/*if(paymentType == 1){
						window.location.href="../../swagent/payforOld.html?reportId=" + myReportId + '&openId=' + myopenId + "&sameUser=" + sameUser+"&agentId=" + agentId;
					}else if(paymentType == 2){
						window.location.href="../../swagent/payfor.html?reportId=" + myReportId + '&openId=' + myopenId + "&sameUser=" + sameUser+"&agentId=" + agentId;
					};*/
					...
					var agentId = indexData.data.indexPage.agentId;
					...
					var myApp = new Vue({
					  ...
					  filters:{
				    	getSecondHref:function(val){
				            return 'second.html?reportId='+myReportId+'&userId='+userId+ '&targetFirstId=' + val+"&agentId=" + agentId 
				       	}
					  }
					...
					//跳转历史报告
					var userId = indexData.data.userId;
					//$('#checkHistory').attr("href",dataUrl + "/wxUser/wxUserReport?jumpUrl=uiAHistory&userId=" + userId + "&openId=" + myopenId + '&reportId=' + myReportId + '&agentId=' + agentId);
					$('#checkHistory').attr("href",dataUrl + "/wxUser/wxUserReport?jumpUrl=uiAHistory&reportId=" + myReportId);
