		...
		if(data.code == 200){
			...
			success : function(indexData) {
				...
				if(indexData.code == 201){
					...
					//跳转历史报告
					var userId = indexData.data.userId;
					$('#checkHistory').attr("href",dataUrl + "/wxUser/agentWxUserReport?jumpUrl=uiKjHistory&userId=" + userId + "&openId=" + myopenId + '&reportId=' + myReportId + '&agentId=' + agentId);
